        ...
        <?php 
            if (!isset($_SESSION["user_logged_in"])){
                ...
                foreach ($results as $result){
                    echo "<li>Link: ".$result[1]."<br>name: ".$result[0]."<br><a href=\"update_website.php?site=".$result[0]."&url=".$result[1]."&siteID=".$result[2]."\">update</a>     <a href=\"delete_website.php?siteID=".$result[2]."\">delete</a></li>";
                }
                echo "</ul>";
